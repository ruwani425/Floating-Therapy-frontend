// Light backgrounds, dark text, dark buttons
                ...
                return (
                  ...
                  >
                    <div className="flex-grow p-6">
                      ...
                      <p className="text-sm font-semibold mb-4 text-cyan-700 px-3 py-1 rounded-full w-fit bg-cyan-100/60 border border-cyan-300/50">
                        {tank.status === "Ready"
